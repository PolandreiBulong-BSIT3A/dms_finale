                ...
                <div key={user.id} className="card shadow-sm">
                  <div className="card-body">
                    <div className="d-flex align-items-start gap-3">
                      ...
                      {user.profilePic ? (
                        <img src={user.profilePic} alt="avatar" style={{ width: '48px', height: '48px', borderRadius: '50%', objectFit: 'cover' }} />
                      ) : (
                        <div 
                          className="d-flex align-items-center justify-content-center fw-bold text-white"
                          style={{ width: '48px', height: '48px', borderRadius: '50%', backgroundColor: '#6366f1', fontSize: '20px' }}
                        >
                      ...
                      <div className="flex-grow-1">
                        ...
                        <div className="text-muted small mt-1">{user.department}</div>
      ...
      <div className="mt-4">
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center" style={{ gap: '8px' }}>
          <div className="text-muted mb-2 mb-md-0" style={{ fontSize: 12 }}>
            ...
            <span className="ms-2">({filteredUsers.length} total)</span>
          </div>
