    ...
    <div style={{...styles.outerWrap, padding: isMobile ? '16px' : '32px 0'}}>
      <div style={{...styles.flexCard, maxWidth: isMobile ? '100%' : 1200}}>
        <div style={{...styles.formCol, padding: isMobile ? '16px' : '32px'}}>
          <div style={{ 
            ...
            <div>
              <h2 style={{...styles.title, fontSize: 'clamp(20px, 4vw, 28px)', margin: 0, paddingTop: 0, textAlign: 'left'}}>Upload Google Drive Link</h2>
          ...
          <div style={{...styles.formInner, padding: isMobile ? '16px' : '32px'}}>
            ...
            <div style={styles.section}>
              <div style={{...styles.inputRow, flexDirection: isMobile ? 'column' : 'row', alignItems: isMobile ? 'flex-start' : 'center'}}>
                <div style={{...styles.inputLabel, minWidth: isMobile ? 'auto' : '120px'}}>Title</div>
                <input style={{...styles.input, fontSize: 'clamp(14px, 2.5vw, 15px)'}} type="text" value={linkTitle} onChange={e => setLinkTitle(e.target.value)} placeholder=" " />
            ...
            <div style={styles.section}>
              <div style={{...styles.inputRow, flexDirection: isMobile ? 'column' : 'row', alignItems: isMobile ? 'flex-start' : 'center'}}>
                <div style={{...styles.inputLabel, minWidth: isMobile ? 'auto' : '120px'}}>Document Type</div>
                <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexDirection: isMobile ? 'column' : 'row', width: isMobile ? '100%' : 'auto' }}>
                  <div style={{...styles.selectContainer, minWidth: isMobile ? '100%' : '400px', width: isMobile ? '100%' : 'auto'}}>
                    <select
                      style={{...styles.select, fontSize: 'clamp(14px, 2.5vw, 15px)'}}
                      value={docType}
            ...
            <div style={styles.section}>
              <div style={{...styles.inputRow, flexDirection: isMobile ? 'column' : 'row', alignItems: isMobile ? 'flex-start' : 'center'}}>
                <div style={{...styles.inputLabel, minWidth: isMobile ? 'auto' : '120px'}}>Folder</div>
                <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexDirection: isMobile ? 'column' : 'row', width: isMobile ? '100%' : 'auto' }}>
                  <div style={{...styles.selectContainer, minWidth: isMobile ? '100%' : '400px', width: isMobile ? '100%' : 'auto'}}>
                    <select
                      style={{...styles.select, fontSize: 'clamp(14px, 2.5vw, 15px)'}}
            ...
            <div style={styles.section}>
              ...
              <div style={{...styles.inputRow, flexDirection: isMobile ? 'column' : 'row', alignItems: isMobile ? 'flex-start' : 'center'}}>
                <div style={{...styles.inputLabel, minWidth: isMobile ? 'auto' : '120px'}}>Date/Time Received</div>
                <input 
                  style={{
                    ...styles.input,
                    fontSize: isMobile ? '16px' : 'clamp(14px, 2.5vw, 15px)', // Prevents zoom on iOS
            ...
            {/* Description */}
            <div style={styles.section}>
              <div style={{...styles.inputRow, flexDirection: isMobile ? 'column' : 'row', alignItems: isMobile ? 'flex-start' : 'flex-start'}}>
                <div style={{...styles.inputLabel, minWidth: isMobile ? 'auto' : '120px'}}>Description <span style={{ color: '#888', fontWeight: 400 }}>(optional)</span></div>
                <textarea
                  style={{...styles.textarea, fontSize: 'clamp(14px, 2.5vw, 15px)'}}
                  value={description}
            ...
            {/* Google Drive Links */}
            <div style={styles.section}>
              <div style={{...styles.inputRow, flexDirection: 'column', alignItems: 'flex-start'}}>
                <div style={{...styles.inputLabel, marginBottom: 8}}>Google Drive Links</div>
                <div style={{ width: '100%' }}>
                  {multipleLinks.map((linkData, index) => (
                    <div key={linkData.id} style={{ 
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{...styles.inputLabel, fontSize: 'clamp(12px, 2vw, 13px)'}}>
                          Google Drive Link {index + 1}
                        </div>
                <input 
                  style={{...styles.input, fontSize: 'clamp(13px, 2.5vw, 15px)'}} 
                  type="url" 
                          value={linkData.link} 
      ...
      {showPreviewPanel && (
        <div style={styles.offCanvasOverlay} onClick={() => setShowPreviewPanel(false)}>
          <div style={{
            ...
            <div style={{...styles.offCanvasHeader, padding: isMobile ? '16px' : '20px 24px'}}>
              <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? '8px' : '16px', flexWrap: 'wrap' }}>
              <h3 style={{...styles.offCanvasTitle, fontSize: 'clamp(16px, 3vw, 18px)'}}>Document Preview</h3>
                {(() => {
                  const validLinks = multipleLinks.filter(link => link.link.trim() && isValidDriveLink(link.link));
                  return validLinks.length > 1 && (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      <span style={{ fontSize: 'clamp(12px, 2vw, 14px)', color: '#666' }}>Link:</span>
                      <select
      ...
      {modalOpen && (
        <div style={styles.modalOverlay} onClick={() => setModalOpen(false)}>
          <div style={{...styles.modalContent, width: isMobile ? '95vw' : 900, height: isMobile ? '80vh' : 600, maxWidth: isMobile ? '95vw' : '90vw'}} onClick={e => e.stopPropagation()}>
...
const styles = {
  ...
  offCanvasPanel: {
    ...
    // Media query moved to inline style where the component is used
  },
  offCanvasHeader: {
    display: 'flex',
    justifyContent: 'space-between',
